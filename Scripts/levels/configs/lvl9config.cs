...
public class lvl9config : MonoBehaviour
{
    void Start()
    {
        spawn.field_size = 9; //Размер поля
        info.steps = 16; // Кол-во ходов, 0 - показывает кол-во ходов, >0 - убывающее кол-во ходов
        ...
        colorBall.timeForExplosion = 40; //Время между взрывами ColorBall'а  [9...]
