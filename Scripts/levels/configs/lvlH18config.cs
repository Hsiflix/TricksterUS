...
public class lvlH18config : MonoBehaviour
{
    void Start()
    {
        ...
        colorBall.timeForExplosion = 1; //Время между взрывами ColorBall'а  [9...]
        ...
        GetComponent<trickHelp>().quantity = Random.Range(5,8);//4; //Кол-во облаков (Мб сделать случайным?)
