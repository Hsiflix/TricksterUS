...
public class lvlH1config : MonoBehaviour
{
    void Start()
    {
        spawn.field_size = 5; //Размер поля
        info.steps = 35; // Кол-во ходов, 0 - показывает кол-во ходов, >0 - убывающее кол-во ходов
        ...
        info.stat_balls = new int[] {2,6,8,11,13,16,18,22}; //Статичные шарики [0..spawn.field_size*spawn.field_size]
