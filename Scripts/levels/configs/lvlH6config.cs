...
public class lvlH6config : MonoBehaviour
{
    void Start()
    {
        spawn.field_size = 3; //Размер поля
        info.steps = 2; // Кол-во ходов, 0 - показывает кол-во ходов, >0 - убывающее кол-во ходов
        info.timersecond = 50; // Кол-во секунд, 0 - показывает время игры, >0 - убывающий таймер
