...
public class lvlH11config : MonoBehaviour
{
    void Start()
    {
        spawn.field_size = 7; //Размер поля
        info.steps = 25; //Кол-во ходов, 0 - показывает кол-во ходов, >0 - убывающее кол-во ходов
        info.timersecond = 1520; //Кол-во секунд, 0 - показывает время игры, >0 - убывающий таймер
        info.winBall = 3; //Победный цвет: 0-blue, 1- yellow, 2- green, 3-red;
        
        info.stat_balls = new int[] {10,16,18,22,26,29,31,33,37,39}; //Статичные шарики [0..spawn.field_size*spawn.field_size]
        ...
        SecretMech.hardLvlTrickHelpCount = 33; //Кол-во помощи трикстера
