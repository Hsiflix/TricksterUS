...
public class lvl12Config : MonoBehaviour {
    ...
    void Start() {
        ...
        Spawn.timerseconds = 80; // Кол-во секунд, 0 - показывает время игры, >0 - убывающий таймер
        ...
        Spawn.WinBall = 4; // Победный цвет: 1-blue, 2- yellow, 3- red, 4-green; 
