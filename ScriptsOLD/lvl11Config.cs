...
public class lvl11Config : MonoBehaviour {
    ...
    //}
    void Start() {
        Spawn.steps = 18; // Кол-во ходов, 0 - показывает кол-во ходов, >0 - убывающее кол-во ходов
        Spawn.timerseconds = 75; // Кол-во секунд, 0 - показывает время игры, >0 - убывающий таймер
